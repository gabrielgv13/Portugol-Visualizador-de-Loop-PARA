...
const TRACE_VECTOR: TraceStep[] = [
  ...
  { step: 2, highlightCode: 'for-init', iValue: 0, output: [], activeIndex: null, message: "O laço PARA inicia. A variável de controle 'i' é criada e recebe o valor inicial 0. Isso é importante: o vetor também começa no índice 0, então 'i' já aponta para a primeira posição!" },
  ...
  { step: 4, highlightCode: 'for-body', iValue: 0, output: ["O índice 0 contém o valor de 10"], activeIndex: 0, message: "Usamos vetor[i], ou seja, vetor[0] = 10. O 'i' funciona como um 'passador de índices': ele nos permite acessar cada posição do vetor sequencialmente! Através do 'i', lemos a posição correta do vetor." },
  ...
  { step: 7, highlightCode: 'for-body', iValue: 1, output: ["O índice 0 contém o valor de 10", "O índice 1 contém o valor de 4"], activeIndex: 1, message: "Usamos vetor[i] novamente, sendo i = 1. Portanto, acessamos vetor[1] = 4. Veja: o 'i' se incrementou e agora aponta para a próxima posição do vetor. É assim que iteramos por todo o vetor!" },
  ...
  { step: 10, highlightCode: 'for-body', iValue: 2, output: ["O índice 0 contém o valor de 10", "O índice 1 contém o valor de 4", "O índice 2 contém o valor de 9"], activeIndex: 2, message: "Agora i = 2, então acessamos vetor[2] = 9. O mecanismo continua: cada vez que 'i' se incrementa, temos acesso ao próximo elemento do vetor. Essa é a beleza do laço com 'vetor[i]'!" },
  ...
  { step: 13, highlightCode: 'for-body', iValue: 3, output: ["O índice 0 contém o valor de 10", "O índice 1 contém o valor de 4", "O índice 2 contém o valor de 9", "O índice 3 contém o valor de 4"], activeIndex: 3, message: "Agora i = 3, e acessamos a última posição: vetor[3] = 4. Resumindo: começamos com i = 0 na primeira posição, e cada incremento de 'i' nos leva à próxima posição do vetor. Dessa forma, conseguimos percorrer todas as 4 posições (0, 1, 2, 3) com um único laço!" },
